...
/**
 * @brief It sets the last message generated by the game events
 * @author Rodrigo
 * * @param game A pointer to the game
 * @param msg A constant string containing the message to be set
 * @return OK if everything goes well, ERROR otherwise
 */
Status game_set_last_message(Game *game, const char *msg);

/**
 * @brief It gets the last message generated by the game events
 * @author Rodrigo
 * * @param game A pointer to the game
 * @return A constant string with the last message, or NULL if there is an error
 */
const char *game_get_last_message(Game *game);

/**
 * @brief It searches for a player in the game using their ID
 * @author Rodrigo
 * * @param game A pointer to the game
 * @param id The identification number of the player to find
 * @return A pointer to the found Player, or NULL if the player doesn't exist or there is an error
 */
